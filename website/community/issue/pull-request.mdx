...
- **Make it clear**: Write clear and concise [commit messages](#sample-commit-messages) and PR descriptions.
...
### Code Conventions
Contributors must follow the standard code style and formatting conventions. Check out [this guide](/community/issue/style-guide/standard-doc-template) to learn more.
