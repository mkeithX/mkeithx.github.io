---
title: Mid-year upgrades
slug: /mid-year-upgrades-2024
authors: [mkeithx]
...
The community across all my projects holds significant importance, which is why I'm introducing the first set of [guidelines](/docs/contributing) for contributors. This guideline outlines what actions will and will not be tolerated. By setting clear standards, I aim to create a welcoming and inclusive environment where everyone feels valued and respected.
