...
const config: Config = {
  ...
  tagline:
    'The official SpaceHub Project site featuring guides and code samples for IT admins and developers.',
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: `announcementBar_`,
      content: `<a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener noreferrer">Articles on this site are licensed under CC BY 4.0</a>`,
      isCloseable: true,
