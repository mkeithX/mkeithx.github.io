---
title: Python Minis
description: Small-scale Python applications
---

# Overview

Small-scale Python applications for beginners who are curious and for advanced users looking for refreshers and fundamentals.
