...
- Admin role in Entra. [Learn more](https://learn.microsoft.com/en-us/entra/global-secure-access/reference-role-based-permissions#role-based-permissions).
- Access to Intune.
...
1. Complete the following steps:
    ...
    - Specify install/uninstall commands.
        ...
        ```powershell
        powershell.exe -ExecutionPolicy Bypass -File GlobalSecureAccessClient.ps1
        ```
