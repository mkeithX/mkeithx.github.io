...
Welcome to the official docs and blog website of the **SpaceHub Project** 🚀
...
<Column className="text--left item  padding--sm">
  ...
  >
    <CardHeader>
      <h3>
        <a href="/docs/system-administration/ms-entra/create-dynamic-group">
...
import M365 from "@site/static/img/logo/Microsoft_365.svg";

import MSFT from "@site/static/img/Microsoft_icon.svg";

import AZD from "@site/static/img/logo/MSAzure.svg";

import Kpx from "@site/static/img/logo/kitimi-icon-new.svg"

<div>

<div align="justify">

<M365 height="65" width="200" />

<AZD height="75" width="200" />


<Kpx height="70" width="50" />
