...
<img src={useBaseUrl('/img/intro-banner-docs.png')} width="300" />
...
<Column className="text--left item  padding--sm">
  <Card
    shadow="lw"
    style={{ border: "1.8px solid var(--spacehub-color-purple)", height: "100%" }}>
    <CardHeader>
      <h3>
...
<img src={useBaseUrl('/img/intro-banner.png')} width="250" />
