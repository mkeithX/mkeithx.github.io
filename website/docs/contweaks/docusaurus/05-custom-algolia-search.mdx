...
Algolia provides [**config templates**](https://docsearch.algolia.com/docs/templates) ensure optimal search experience. Feel to copy the following custom configuration:
