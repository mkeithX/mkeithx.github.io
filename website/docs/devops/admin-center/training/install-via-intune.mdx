...
<a class="button button--outline button--primary" href="ms-windows-store://pdp/?productid=9WZDNCRFJ3PZ" target="_blank"><FAIcon icon="fa-brands fa-windows" size="2x"/></a>

<a class="button button--outline button--secondary" href="https://apps.apple.com/us/app/intune-company-portal/id719171358" target="_blank"><FAIcon icon="fa-brands fa-apple" size="2x"/></a>

<a class="button button--outline button--success" href="https://play.google.com/store/apps/details?id=com.microsoft.windowsintune.companyportal&hl=en_US" target="_blank"><FAIcon icon="fa-brands fa-google-play" size="2x"/></a>
