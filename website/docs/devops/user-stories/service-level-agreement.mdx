...
I want to
define clear priority levels and enforce associated SLAs for IT support requests, so that
...
A clear and concise definition of ticket categories base on: [**type**](#type), [**priority**](#priority-level), and [**status**](#status).
