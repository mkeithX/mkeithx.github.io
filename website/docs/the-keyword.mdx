...
### DevTools
To build this website, I use VSCode along with helpful plugins and various [open-source resources](/community). While the main configuration may seem intricate, it aims to optimize the framework's performance. Learn [more](/docs/configuration).
