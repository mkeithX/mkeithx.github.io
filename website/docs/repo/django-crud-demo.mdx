...
# `django-crud-demo`
This article outlines features and functionalities of the [`django-crud-demo`](https://github.com/mkeithX/django-crud-demo) project, assuming that you have it installed and properly configured on your machine.
