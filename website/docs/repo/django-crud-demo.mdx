...
# `django-crud-demo`
The full feature and functionalities of the [`django-crud-demo`](https://github.com/mkeithX/django-crud-demo) project.
...
:::tip[Important]
This article assumes that you already have the `django-crud-demo` installed and properly configured in your machine
:::
